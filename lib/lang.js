export const lang = {
  zh: {
    ...
    CONTACT: {
      ...
      FAILED_MESSAGE: '抱歉, 发送失败, 请稍后重试'
    },
    FOOTER: {
      COPYRIGHT_ORIGIN_START: '本文为转载文章，著作权归作者所有。',
      COPYRIGHT_ORIGIN_AUTHOR: '原文作者： ',
      COPYRIGHT_ORIGIN_POST_LINK: '原文链接： ',
      COPYRIGHT_AUTHOR: '本文作者： ',
      COPYRIGHT_POST_LINK: '本文链接： ',
      COPYRIGHT: '许可声明：',
      COPYRIGHT_POST_START: '本文为原创文章，采用 ',
      COPYRIGHT_START: '本站原创内容基于 ',
      COPYRIGHT_NAME: 'CC BY-SA 4.0 DEED',
      COPYRIGHT_LINK:
        'https://creativecommons.org/licenses/by-sa/4.0/deed.zh-hans',
      COPYRIGHT_END: ' 许可协议，转载请注明出处'
    },
    ERROR: {
      MESSAGE: '一些错误使我们在此相遇',
      TITLE: '页面无法找到',
      ...
      BACK_TO_HOME: '返回首页',
      CRAFTDOCS_ERROR:
        '当你看到这行字的时候, 说明你的配置页面格式有误, 请检查你的 Craft.do 配置文档.',
      LOADING: '正在加载....',
  ...
  en: {
    ...
    CONTACT: {
      ...
      FAILED_MESSAGE: 'Sorry, sending failed, please try again later'
    },
    FOOTER: {
      COPYRIGHT_ORIGIN_START: '本文为转载文章，著作权归作者所有。',
      COPYRIGHT_ORIGIN_AUTHOR: 'author: ',
      COPYRIGHT_ORIGIN_POST_LINK: 'link: ',
      COPYRIGHT_AUTHOR: 'author: ',
      COPYRIGHT_POST_LINK: 'link: ',
      COPYRIGHT: '',
      COPYRIGHT_POST_START: 'This post is licensed under the ',
